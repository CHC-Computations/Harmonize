...
<div class="box-Body">
	...
	<div class="box-Desc">
		...
		<?php else: ?>	
			<a class="box-bottom-link" href="<?= $result->solrRecord->bottomLink ?>" title="<?= $result->solrRecord->bottomStr ?>"><?= $result->solrRecord->bottomStr ?></a>
		<?php endif; ?>	
		
	</div>
	
</div>
<?php if (!empty($result->solrRecord->bottomLinks)) :?>
	<div class="box-footer">
		<?= $result->solrRecord->bottomLinks ?>
	</div>	
<?php endif; ?>		
