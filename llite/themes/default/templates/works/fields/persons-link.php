...
if (!empty($this->workRecord->personsCount[$personId]))
	echo '<span class="badge" style="float:right" title="'.$this->transEsc('number of publications').'" data-toggle="tool-tip" >'.$this->workRecord->personsCount[$personId].'</span>';
?>
