...
echo '<tr id="result_'.uniqid().'">
		...
		<td class="media" style="cursor:pointer" title="'.$this->transEsc('preview this record').'" OnClick="results.preViewCopy(\''.$record->title.'\', \''.$box_id .'\');">'.$this->render('record/cover.php', ['result' => $result]).'</td>
