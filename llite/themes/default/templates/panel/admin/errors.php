...
$this->addJS('
	page.phpResults = "/service/admin/errors.results";
	page.phpFilters = "/service/admin/errors.filters";
	page.phpAction = "/service/admin/errors.edit";
	page.results("1", "time DESC");
	page.filters();
	');
